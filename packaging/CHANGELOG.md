...
**A small fix for Dyson Sphere Program 0.10.35.** The game update added a recipe, and that could move
a planet's anomaly -- about one in 150. This puts it back, keeps it from happening again, and adds an
opt-in for players who want the new recipe. Nothing else changes.
